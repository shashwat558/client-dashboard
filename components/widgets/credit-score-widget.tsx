    ...
    <Card className="p-6 shadow-2xs">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="text-sm border border-gray-300 rounded-sm px-2 py-1 text-gray-600 hover:text-gray-900"
        >
          Details
        </button>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between">
          <p className="text-lg text-gray-900">
            <span className="text-gray-500">Your</span> credit score <span className="text-gray-500">is</span> <span className="text-gray-900">{score}</span>
            <p className="text-sm text-gray-600">This score is considered to be {status}.</p>
          </p>
          <span className="text-xl ml-2 p-2 rounded-full bg-[#FFF1EB]">{emoji}</span>
        </div>
